    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-500">{company.industry || (isEn ? "Internet" : "互联网")}</p>
        </div>
        <div className="text-right flex-shrink-0">
          <p className="text-sm font-medium text-[#6366f1]">{jobCount} {t('companyCard.openPositions')}</p>
        </div>
      </Link>
    );
  }
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-3 mb-4">
          ...
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#eef2ff] text-[#4f46e5] text-sm rounded-lg font-medium">
            ...
            {jobCount} {t('companyCard.openPositions')}
          </span>
        </div>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-500">{isEn ? "Bookmark" : "收藏"}</span>
          </div>
