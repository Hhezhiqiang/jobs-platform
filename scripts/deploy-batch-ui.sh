...
curl -sL https://raw.githubusercontent.com/Hhezhiqiang/jobs-platform/main/src/app/api/jobs/batch-apply/route.ts -o src/app/api/jobs/batch-apply/route.ts
mkdir -p src/app/api/jobs/batch-apply
