...
import { Briefcase, BookOpen, TrendingUp, User, Search, MessageCircle, DollarSign, Users, IdCard } from "lucide-react";
...
export function MobileBottomNav() {
  ...
  const navItems = [
    ...
    { label: isEn ? "Salary" : "薪资", href: `/${locale}/salary-insights`, icon: DollarSign },
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-[10px] mt-0.5 truncate w-full text-center ${active ? "font-medium text-blue-600" : ""}`}>
                  {item.label}
                </span>
              </Link>
            );
